...
describe('LargeTitle', () => {
  ...
  it('applies custom className', () => {
    const { container } = render(<LargeTitle className="custom-class">Test Title</LargeTitle>);
    const element = container.querySelector('h1');
    expect(element).toHaveClass('custom-class');
  });

  it('renders with a different component when specified', () => {
    const { container } = render(<LargeTitle Component="h2">Test Title</LargeTitle>);
  ...
  it('passes additional props to the Typography component', () => {
    const { container } = render(<LargeTitle data-testid="large-title">Test Title</LargeTitle>);
    const element = container.querySelector('h1');
